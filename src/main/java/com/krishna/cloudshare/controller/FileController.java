package com.krishna.cloudshare.controller;

import com.krishna.cloudshare.service.FileSharer;
...
public class FileController {
    ...
    public FileController(int port) throws IOException {
        ...
        this.uploadDir = System.getProperty("java.io.tmpdir") + File.separator + "cloudshare-uploads";
    ...
    private class UploadHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if (contentType == null || !contentType.toLowerCase().startsWith("multipart/")) {
                String response = "Bad Request: Must be multipart/form-data";
            ...
            RequestContext requestContext = new HttpExchangeRequestContext(exchange);
            ...
            try {
                ...
                if (fileItem == null || fileItem.getName() == null || fileItem.getName().trim().isEmpty()) {
                    String response = "Bad Request: No file uploaded";
                    exchange.sendResponseHeaders(400, response.getBytes().length);
                    try (OutputStream os = exchange.getResponseBody()) {
                        os.write(response.getBytes());
                    }
